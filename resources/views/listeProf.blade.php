...
<!-- resources/views/listeProf.blade.php -->
        ...
        <div class="container">
            ...
            <ul class="list-group ">
                @foreach ($teachers as $teacher)
                    <li class="list-group-item rounded bg-info mb-3">
                        <h5 class="font-weight-bold mb-0">{{ $teacher->name }}</h5>
                        <p class="mb-1"><a href="">{{ $teacher->email }}</a></p>
                        <p class="mb-0">{{ $teacher->phone }}</p>
                        <!-- Ajoutez d'autres détails du professeur ici -->
                    </li>
                @endforeach
            </ul>
            <hr class="my-4"> <!-- Ajoutez une ligne de séparation -->
        </div>
    </section>
