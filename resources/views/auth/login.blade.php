            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Connecter vous a votre compte</h5>
                    <p class="text-center small">Entrer votre login & Mots de passe</p>
                  </div>
        ...
        @csrf
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Souvenez moi?</label>
                      </div>
                    </div>
                    <div class="col-12">
...
<form method="POST" action="{{ route('login') }}">
        ...
        <!-- Password -->
        <div class="col-12">    
        <label  for="yourPassword" class="form-label">Mot de Passe </label><br>
...
<!-- ***************** -->
              ...
              <div class="credits">
                ...
                Designed by <a href="#">L'équipe Alpha</a>
              </div>
